                ...
                <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                  ...
                  <SheetContent className="p-0 overflow-scroll">
                    ...
                    <Calendar
                      ...
                      className="mt-6 border-b border-solid border-secondary"
                      locale={ptBR}
                      styles={{
                        head_cell: {
                          width: "100%",
                    ...
                    />
                    {/* show scheduling list */}
                    {date && (
                      <div className="px-5 py-6 gap-3 overflow-x-auto [&::-webkit-scrollbar]:hidden border-y border-solid border-secondary flex">
                        {timeList.map((time) => (
                          <Button
